...
/**
 * Test for alpha hanto class imported from Blackboard posted by Professor Pollice.
 * 
 * @author troyling
 * 
 */
public class AlphaHantoMasterTest {
	...
	/**
	 * Attempt to place sparrow instead of the butterfly at the origin. Exception is expected.
	 * 
	 * @throws HantoException
	 */
	...
	/**
	 * Player in blue attempts to place butterfly at place other than origin. Exception is expected.
	 * 
	 * @throws HantoException
	 */
	@Test(expected = HantoException.class)
	...
	/**
	 * Attempt to place the second piece at the nonadjacent tile. Exception is expected.
	 * 
	 * @throws HantoException
	 */
	@Test(expected = HantoException.class)
